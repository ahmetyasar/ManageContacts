...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select Role from tbladmin where  UserName='$adminuser' && Password='$password' ");
...
<head>
  ...
  <title>Rehber Admin - Giriş</title>
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">Rehber Yönetim Sistemi || Danışma Girişi</div>
      <div class="card-body">
    ...
    echo $msg;
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="forget-password.php">Şifremi Unuttum?</a>
        </div>
      </div>
    </div>
  </div>

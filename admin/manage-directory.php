    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Rehberi Düzenle</li>
        </ol>
...
?>
                ...
                <td><a href="edit-directory.php?editid=<?php echo $row['ID'];?>">Kayıt Düzenle</a>
                  <td><a href="delete-data.php?delid=<?php echo $row['ID'];?>">Kayıt Sil</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
